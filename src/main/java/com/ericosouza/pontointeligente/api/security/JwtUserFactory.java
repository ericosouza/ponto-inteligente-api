package com.ericosouza.pontointeligente.api.security;
...
public class JwtUserFactory {
	...
	public static JwtUser create(Funcionario funcionario) {
		return new JwtUser(funcionario.getId(), funcionario.getEmail(), funcionario.getSenha(), JwtUserFactory.mapToGrantedAuthorities(funcionario.getPerfil()));
	}
