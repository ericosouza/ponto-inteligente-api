...
import com.ericosouza.pontointeligente.api.dtos.CadastroPJDto;
...
@CrossOrigin(origins="*")//aceita requisição de qualquer lugar
public class CadastroPJController {
	...
	public ResponseEntity<Response<CadastroPJDto>> cadastrar(@Valid @RequestBody CadastroPJDto cadastroPJDto, BindingResult result) throws NoSuchAlgorithmException{
		CadastroPJController.log.info("Cadastrando PJ: {}", cadastroPJDto.toString());
		...
		if (result.hasErrors()) {
			CadastroPJController.log.error("Erro validando dados de cadastro PJ: {}", result.getAllErrors());
