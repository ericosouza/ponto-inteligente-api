...
import com.ericosouza.pontointeligente.api.dtos.FuncionarioDto;
...
public class FuncionarioController {
	...
	public ResponseEntity<Response<FuncionarioDto>> atualizar(@PathVariable("id") Long id,
		...
		if (result.hasErrors()) {
			FuncionarioController.log.error("Erro validando funcionário: {}", result.getAllErrors());
	...
	private void atualizarDadosFuncionario(Funcionario funcionario, FuncionarioDto funcionarioDto, BindingResult result) throws NoSuchAlgorithmException {
		...
		funcionarioDto.getQtdHorasTrabalhoDia().ifPresent(qtdHorasTrabDia -> funcionario.setQtdHorasTrabalhadaDia(Float.valueOf(qtdHorasTrabDia)));
	...
	private FuncionarioDto converterFuncionarioDto(Funcionario funcionario) {
		...
		funcionario.getQtdHorasTrabalhadaDiaOpt().ifPresent(qtdHorasTrabDia -> funcionarioDto.setQtdHorasTrabalhoDia(Optional.of(Float.toString(qtdHorasTrabDia))));
