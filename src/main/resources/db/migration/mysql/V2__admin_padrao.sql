...
VALUES (NULL, '82198127000121', CURRENT_DATE(), CURRENT_DATE(), 'Erico IT');
...
VALUES (NULL, '16248890935', CURRENT_DATE(), CURRENT_DATE(), 'admin@ericosouza.com', 'ADMIN', 'ROLE_ADMIN', NULL, NULL, 
